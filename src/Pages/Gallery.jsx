...
const Gallery = () => {
    ...
    return (
        <div className="space-y-10">
            ...
            <h1 className="text-center text-5xl">Our <span className="font-extrabold bg-clip-text text-transparent bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-red-500 to-red-600">Gallery</span></h1>
            <p className="text-center text-2xl">Check Out photos taken by Our Professional Photographers</p>
            </div>
