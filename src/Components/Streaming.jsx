const Streaming = () => {
  return (
    <div className="max-w-screen-xl mx-auto mb-16">
      ...
      <div data-aos="flip-down" data-aos-duration="1500" className="grid grid-cols-1 md:grid-cols-2 mt-10 gap-6">
      ...
      <div className="mt-10">
        <h1 data-aos="zoom-in" data-aos-duration="1500" className="text-5xl text-center italic ">Watch <span className="font-extrabold bg-clip-text text-transparent bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-red-500 to-red-600">Live</span></h1>
