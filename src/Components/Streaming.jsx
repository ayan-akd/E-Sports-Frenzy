const Streaming = () => {
  return (
    <div className="max-w-screen-xl mx-auto mb-16">
      ...
      <div className="mt-10">
        <h1 className="text-5xl text-center italic ">Watch <span className="font-extrabold bg-clip-text text-transparent bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-red-500 to-red-600">Live</span></h1>
        <div>
